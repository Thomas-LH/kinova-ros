...
let PoseAndSizeGoal = require('./PoseAndSizeGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PoseAndSizeActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PoseAndSizeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PoseAndSizeGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PoseAndSizeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PoseAndSizeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PoseAndSizeGoal()
    }
...
module.exports = PoseAndSizeActionGoal;
